...
public interface JobService {
	boolean scheduleOneTimeJob(String jobName, String jobType, Class<? extends QuartzJobBean> jobClass, Date date);
	boolean scheduleCronJob(String jobName, String jobType, Class<? extends QuartzJobBean> jobClass, Date date, String cronExpression);
