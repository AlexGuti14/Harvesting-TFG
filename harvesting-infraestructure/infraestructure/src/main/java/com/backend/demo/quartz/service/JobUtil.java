...
import com.backend.demo.quartz.config.PersistableCronTriggerFactoryBean;
...
class JobUtil {
	...
	protected static JobDetail createJob(Class<? extends QuartzJobBean> jobClass, boolean isDurable, 
			ApplicationContext context, String jobName, String jobType, String jobGroup){
		...
		jobDataMap.put("jobName", jobType);
