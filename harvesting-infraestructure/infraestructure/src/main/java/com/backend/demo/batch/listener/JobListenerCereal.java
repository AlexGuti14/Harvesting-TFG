 ...
 *
 */
public class JobListenerCereal extends JobExecutionListenerSupport {

	private static final Logger log = LoggerFactory.getLogger(JobListenerCereal.class);

	private String webUrl;
	private String fileUrl;
	private String saveDir;
	private String patron;
	private List<CerealReader> cerealReaders;

	public JobListenerCereal(String webUrl, String fileUrl, String saveDir, String patron, List<CerealReader> cerealReaders) {
		this.webUrl = webUrl;
		this.fileUrl = fileUrl;
		this.saveDir = saveDir;
		this.patron = patron;
		this.cerealReaders = cerealReaders;
	}
	...
	public void beforeJob(JobExecution jobExecution) {
        ...
        try {
			...
			for (CerealReader cerealReader : cerealReaders) {
				cerealReader.filesToRead(filesToRead);
			}
