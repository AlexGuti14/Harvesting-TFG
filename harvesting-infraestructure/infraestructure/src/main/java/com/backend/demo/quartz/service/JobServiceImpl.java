...
public class JobServiceImpl implements JobService{
	 ...
	 */
	@Override
	public boolean scheduleOneTimeJob(String jobName, String jobType, Class<? extends QuartzJobBean> jobClass, Date date) {
		System.out.println("Request received to scheduleSimpleJob");

		String jobKey = jobName;
		String groupKey = "SampleGroup";	
		String triggerKey = jobName;		

		JobDetail jobDetail = JobUtil.createJob(jobClass, false, context, jobKey, jobType, groupKey);
	 ...
	 */
	@Override
	public boolean scheduleCronJob(String jobName, String jobType, Class<? extends QuartzJobBean> jobClass, Date date, String cronExpression) {
